  ...
  foreach ($items as $item) {
      ...
      foreach ($fc->field_section_title as $contents) {
        foreach ($contents as $content) {
          if (!empty($content['value'])) {
            $output .= "\r" . '    "field_section_title"=>"' . htmlspecialchars($content['value'], ENT_QUOTES) . '", ';
          }
        }
      }
    }
    ...
    if (!empty($fc->field_section_description)) {
      foreach ($fc->field_section_description as $contents) {
        foreach ($contents as $content) {
          if (!empty($content['value'])) {
            $output .= "\r" . '    "field_section_description"=>"' . htmlspecialchars($content['value'], ENT_QUOTES) . '", ';
          }
        }
      }
    }
    ...
    if (!empty($fc->field_section_html)) {
      foreach ($fc->field_section_html as $contents) {
        foreach ($contents as $content) {
          if (!empty($content['value'])) {
            $output .= "\r" . '    "field_section_html"=>"' . htmlspecialchars($content['value'], ENT_QUOTES) . '", ';
          }
        }
      }
    }
